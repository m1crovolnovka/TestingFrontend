  ...
  return _createClass(AllureReporter, [{
    ...
    value: function onStepEnd(test, _result, step) {
      ...
      this.allureRuntime.updateStep(stepUuid, function (stepResult) {
        ...
        var _ref4 = (_getWorstTestStepResu3 = (0, _reporter.getWorstTestStepResult)(stepResult.steps)) !== null && _getWorstTestStepResu3 !== void 0 ? _getWorstTestStepResu3 : {},
          _ref4$status = _ref4.status,
          status = _ref4$status === void 0 ? _allureJsCommons.Status.PASSED : _ref4$status;
        stepResult.status = step.error ? _allureJsCommons.Status.FAILED : status;
        stepResult.stage = _allureJsCommons.Stage.FINISHED;
        if (step.error) {
          stepResult.statusDetails = _objectSpread({}, (0, _sdk.getMessageAndTraceFromError)(step.error));
